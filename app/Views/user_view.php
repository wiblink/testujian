       ...
       <tbody>
          ...
          <tr>
             ...
             <td><?php
                    ...
                    ?></td>
             <td>
              <a href="<?php echo base_url('user-edit-view/'.$user['user_id']);?>" class="btn btn-primary btn-sm">Edit</a>
              <a href="<?php echo base_url('delete-user/'.$user['user_id']);?>" class="btn btn-danger btn-sm">Delete</a>
              </td>
          </tr>
         <?php endforeach; ?>
         <?php endif; ?>
